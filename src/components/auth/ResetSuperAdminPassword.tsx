...
import {
  useSuperAdminCheckTokenValidity,
...
export default function ResetSuperAdminPassword() {
  ...
  const resetPasswordMutation = useSuperAdminResetPassword()
  const { data: tokenValidityData, isLoading } =
    useSuperAdminCheckTokenValidity(searchParams.get('token') || '')
